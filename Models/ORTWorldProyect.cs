...
namespace ORTWorldProyect.Models
{
 public class OrtWorld{
    ...
    public static Dictionary<string, PaqueteProyect.Models.Paquete> Paquetes {get; private set;}
    public static bool IngresarPaquete(string destinoSeleccionado, PaqueteProyect.Models.Paquete paquete){
        bool devolver = false;
